...
class B_tweed_pack_wasser_molle_od7       : w28_B_wasser_molle_aceax { camo = "OD"; style = "Ready"; };
class B_tweed_pack_wasser_molle_od7_alt   : w28_B_wasser_molle_aceax { camo = "OD"; style = "Stowed"; };

class B_tweed_pack_wasser_molle_od3       : w28_B_wasser_molle_aceax { camo = "CYT";   style = "Ready"; };
class B_tweed_pack_wasser_molle_od3_alt   : w28_B_wasser_molle_aceax { camo = "CYT";   style = "Stowed"; };
...
class B_tweed_pack_camel_thermos_od7 : w28_B_camel_thermos_aceax { camo = "OD"; };
class B_tweed_pack_camel_thermos_od3 : w28_B_camel_thermos_aceax { camo = "CYT"; };
...
class B_simc_US_Molle_asspack_OCP_thermos_od7 : w28_B_simc_asspack_aceax { variant = "Camelbak"; camo = "OD"; position = "Standard"; };
class B_simc_US_Molle_asspack_OCP_thermos_od3 : w28_B_simc_asspack_aceax { variant = "Camelbak"; camo = "CYT"; position = "Standard"; };
...
class B_simc_US_Molle_sturm_OCP_thermos_od7 : w28_B_simc_sturm_aceax { variant = "Camelbak"; camo = "OD"; equipment = "Standard"; };
class B_simc_US_Molle_sturm_OCP_thermos_od3 : w28_B_simc_sturm_aceax { variant = "Camelbak"; camo = "CYT";   equipment = "Standard"; };
class B_simc_US_Molle_sturm_OCP_RTO_wasser  : w28_B_simc_sturm_aceax { variant = "Camelbak"; camo = "CYT";   equipment = "Radio"; };
